...
Incluye autenticación, auditoría y notificaciones
"""
...
from database.workers_json import init_json_db, obtener_trabajadores, obtener_rubros, obtener_horas_trabajador, obtener_total_horas
...
# CSS personalizado + Ocultar elementos de Streamlit
st.markdown("""
    <style>
    /* Ocultar menú hamburguesa y elementos innecesarios */
...
def inicializar_bases_datos():
    ...
    print("✅ Bases de datos inicializadas (JSON)")
...
def main():
    ...
    if "Dashboard" in page or "Mis Horas" in page:
        ...
        from pages.areas import show_areas_page
        show_areas_page()
